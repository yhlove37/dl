	...
	<body>
		<div class="container-fluid">
			...
			<div class="container-fluid">
				...
				<div class="col-md-2 hidden-xs hidden-md hidden-sm" style="border:1px solid #E7E7E7;border-right:0;padding:0;">
					<img src="products/hao/c2.png" width="240" height="404" style="display: inline-block;"/>
				</div>
				<div class="col-md-10">
					<div class="col-md-6 hidden-xs hidden-md hidden-sm" style="text-align:center;height:200px;padding:0px;">
						<a href="#">
							<img src="products/hao/c1.png" width="516px" height="200px" style="display: inline-block;">
						</a>
					</div>
			...
			<div class="container-fluid">
				...
				<div class="col-md-2 hidden-xs hidden-md hidden-sm" style="border:1px solid #E7E7E7;border-right:0;padding:0;">
					<img src="products/hao/c22.jpg" width="205" height="404" style="display: inline-block;"/>
				</div>
				<div class="col-md-10 ">
					<div class="col-md-6 hidden-xs hidden-md hidden-sm" style="text-align:center;height:200px;padding:0px;">
						<a href="#">
							<img src="products/hao/c21.jpg" width="516px" height="200px" style="display: inline-block; object-fit: cover">
						</a>
					</div>
