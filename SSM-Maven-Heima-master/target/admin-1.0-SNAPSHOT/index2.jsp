    ...
    <div class="layui-layout-admin">
        <div class="layui-header">
            ...
            <ul class="layui-nav layui-layout-right">
                <li class="layui-nav-item">
                    <a href="javascript:;">
                        <img src="admin2/images/img.jpg" class="layui-nav-img">
                        admin
                    </a>
                    <dl class="layui-nav-child">
                        <dd><a href="">资料</a></dd>
        ...
        <div class="layui-side layui-bg-black">
            <div class="layui-side-scroll">
                ...
                <ul class="layui-nav layui-nav-tree" lay-filter="test">
                    ...
                    <li class="layui-nav-item">
                        <a data_herf="./page/page1.html" href="javascript:;">用户管理</a>
                    </li>
                    <li class="layui-nav-item">
                        <a data_herf="./page/page2.html" href="javascript:;">商品信息管理</a>
                    </li>
                    <li class="layui-nav-item">
                        <a data_herf="./page/page2.html" href="javascript:;">订单管理</a>
                    </li>
                </ul>
            </div>
        </div>
