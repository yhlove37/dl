...
public class ProductServiceImpl implements ProductService {
    ...
    //更新用户地址
    @Override
    public void updateOrderAddr( String address,String name,String telephone,String oid) {
        mapper.updateOrderAddr(address,name,telephone,oid);
    }
    ...
    @Override
    public void deleteOrderByoid(String oid1) {
         mapper.deleteOrderByoid(oid1);
    }
