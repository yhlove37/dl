...
<head>
    ...
    <title>表单1</title>
    <link rel="stylesheet" href="${pageContext.request.contextPath}/admin2/layui/css/layui.css">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/admin2/css/index.css">
	<script src="${pageContext.request.contextPath}/admin2/layui/layui.js"></script>
